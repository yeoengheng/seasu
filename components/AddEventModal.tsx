function AddEventModal():JSX.Element{
    return(    
        <div id="eventadd-modal" aria-hidden="true" className="hidden fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
            <div className="relative w-full h-full max-w-md md:h-auto">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button" className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="eventadd-modal">
                    ...
                    <div className="py-6 px-6 lg:px-8">
                        ...
                        <form className="space-y-6" action="#">
                            ...
                            <div>
                                ...
                                <input name="name" id="name" placeholder="Stripe Meetup" className="inputStyle" required/>
                            </div>
                            <div>
